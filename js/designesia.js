...
(function($) {
	'use strict';
    setInterval(function(){$('.btn-buy, .scrollbar-v, .float-text, #back-to-top, #buy-now, #selector, .show-on-scroll').hide();},100);
    ...
    var header = $("header");
     ...
     // rtl begin //
      if (rtl_mode==="on") {
            ...
            jQuery("#bootstrap").attr("href", 'css/bootstrap.rtl.min.html');
